...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.slug'
        db.alter_column('submissions_challenge', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=200))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Challenge.slug'
        db.alter_column('submissions_challenge', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100, unique=True))
