...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.is_grand_champ'
        db.add_column('submissions_entry', 'is_grand_champ',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.is_grand_champ'
        db.delete_column('submissions_entry', 'is_grand_champ')
    ...
    models = {
        ...
        'submissions.entry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_grand_champ': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
