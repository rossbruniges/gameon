...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.team_description'
        db.add_column('submissions_entry', 'team_description',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Entry.team_description'
        db.delete_column('submissions_entry', 'team_description')
